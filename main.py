...
from domain.style.style import style
...
def handle_exit(total_translations, correct_translations):
    print(f"{style.GREEN}correct{style.RESET}:  {correct_translations}")
    print(f"{style.RED}wrong{style.RESET}: {total_translations - correct_translations}")
    print(f"{style.BLUE}total{style.RESET}: {total_translations}")
